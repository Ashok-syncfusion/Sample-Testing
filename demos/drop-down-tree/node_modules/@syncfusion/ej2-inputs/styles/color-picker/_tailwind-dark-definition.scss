//default 
$cpicker-split-btn-padding: 0 8px !default;
$cpicker-bigger-split-btn-padding: 0 12px !default;
...
$cpicker-slider-handler-box-shadow: $shadow !default;
$cpicker-slider-handle-size: 12px !default;
$cpicker-slider-handle-top: calc(58% - 7px) !default;
$cpicker-slider-handler-focus-color: $info !default;
$cpicker-bigger-slider-handle-size: 16px !default;
$cpicker-bigger-slider-handle-top: calc(52% - 8px) !default;
$cpicker-input-picker-padding: 0 8px 12px 9px !default;
...
$cpicker-preview-margin-left: 14px !default;
$cpicker-bigger-preview-margin-left: 16px !default;
