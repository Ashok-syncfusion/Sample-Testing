...
define(["require", "exports", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-lists", "@syncfusion/ej2-popups", "@syncfusion/ej2-base", "@syncfusion/ej2-popups", "../common/h-scroll", "../common/v-scroll", "../common/menu-scroll"], function (require, exports, ej2_base_1, ej2_base_2, ej2_base_3, ej2_base_4, ej2_base_5, ej2_lists_1, ej2_popups_1, ej2_base_6, ej2_popups_2, h_scroll_1, v_scroll_1, menu_scroll_1) {
    "use strict";
    ...
    var FieldSettings = (function (_super) {
        ...
        __decorate([
            ej2_base_1.Property('url')
        ], FieldSettings.prototype, "url", void 0);
        __decorate([
            ej2_base_1.Property('separator')
        ], FieldSettings.prototype, "separator", void 0);
        __decorate([
            ej2_base_1.Property('items')
    ...
    var MenuAnimationSettings = (function (_super) {
    ...
    var MenuBase = (function (_super) {
        ...
        MenuBase.prototype.preRender = function () {
            if (!this.isMenu) {
                ...
                if (this.element.tagName === 'EJS-CONTEXTMENU') {
                    ul = this.createElement('ul', {
                        id: ej2_base_4.getUniqueID(this.getModuleName()), className: 'e-control e-lib e-' + this.getModuleName()
                    });
                    var ejInst = ej2_base_4.getValue('ej2_instances', this.element);
                    ej2_base_5.removeClass([this.element], ['e-control', 'e-lib', 'e-' + this.getModuleName()]);
                    this.clonedElement = this.element;
                    this.element = ul;
                    ej2_base_4.setValue('ej2_instances', ejInst, this.element);
                }
                else {
                    ul = this.createElement('ul', { id: ej2_base_4.getUniqueID(this.getModuleName()) });
                    ej2_base_5.append([].slice.call(this.element.cloneNode(true).children), ul);
            ...
            if (this.element.tagName === 'EJS-MENU') {
                ...
                var ejInstance = ej2_base_4.getValue('ej2_instances', ele);
                ...
                ej2_base_5.detach(ele);
                ele = ul;
                wrapper.appendChild(ele);
                ej2_base_4.setValue('ej2_instances', ejInstance, ele);
        ...
        MenuBase.prototype.render = function () {
            this.initialize();
            this.renderItems();
            if (this.isMenu && this.template && ej2_base_6.isBlazor()) {
                var menuTemplateId = this.element.id + TEMPLATE_PROPERTY;
                ej2_base_6.resetBlazorTemplate(menuTemplateId, TEMPLATE_PROPERTY);
                if (Object.keys(ej2_base_6.blazorTemplates).length) {
                    ej2_base_6.extend(this.tempItem, ej2_base_6.blazorTemplates[menuTemplateId], [], true);
                }
                ej2_base_6.updateBlazorTemplate(menuTemplateId, TEMPLATE_PROPERTY, this);
            }
            this.wireEvents();
            this.renderComplete();
        };
        MenuBase.prototype.initialize = function () {
            ...
            if (this.cssClass) {
                ej2_base_5.addClass([wrapper], this.cssClass.split(' '));
            }
            if (this.enableRtl) {
        ...
        MenuBase.prototype.renderItems = function () {
            if (!this.items.length) {
                var items = ej2_lists_1.ListBase.createJsonFromElement(this.element, { fields: { child: 'items' } });
            ...
            if (this.isMenu) {
                ...
                if (this.enableScrolling) {
                    ...
                    if (this.element.classList.contains('e-vertical')) {
                        menu_scroll_1.addScrolling(this.createElement, wrapper, this.element, 'vscroll', this.enableRtl);
                    }
                    else {
                        menu_scroll_1.addScrolling(this.createElement, wrapper, this.element, 'hscroll', this.enableRtl);
                    }
                }
            }
        };
        MenuBase.prototype.wireEvents = function () {
            ...
            if (this.target) {
                ...
                for (var i = 0, len = targetElems.length; i < len; i++) {
                    ...
                    if (this.isMenu) {
                        ej2_base_2.EventHandler.add(target, 'click', this.menuHeaderClickHandler, this);
                    }
                    else {
                ...
                if (!this.isMenu) {
                    ej2_base_2.EventHandler.add(this.targetElement, 'scroll', this.scrollHandler, this);
                    for (var _i = 0, _a = ej2_popups_2.getScrollableParent(this.targetElement); _i < _a.length; _i++) {
                        var parent_1 = _a[_i];
            ...
            if (!ej2_base_4.Browser.isDevice) {
                ...
                ej2_base_2.EventHandler.add(this.isMenu ? document : wrapper, 'mouseover', this.delegateMoverHandler, this);
                ej2_base_2.EventHandler.add(document, 'mousedown', this.delegateMouseDownHandler, this);
            }
            this.delegateClickHandler = this.clickHandler.bind(this);
            ej2_base_2.EventHandler.add(document, 'click', this.delegateClickHandler, this);
            this.wireKeyboardEvent(wrapper);
            this.rippleFn = ej2_base_5.rippleEffect(wrapper, { selector: '.' + ITEM });
        };
        MenuBase.prototype.wireKeyboardEvent = function (element) {
            ...
            new ej2_base_2.KeyboardEvents(element, {
                keyAction: this.keyBoardHandler.bind(this),
                keyConfigs: keyConfigs
            });
        };
        MenuBase.prototype.mouseDownHandler = function (e) {
            if (ej2_base_5.closest(e.target, '.e-' + this.getModuleName() + '-wrapper') !== this.getWrapper()
                && (!ej2_base_5.closest(e.target, '.e-' + this.getModuleName() + '-popup'))) {
        ...
        MenuBase.prototype.keyBoardHandler = function (e) {
            ...
            if (this.enableScrolling && e.keyCode === 13 && trgt.classList.contains('e-scroll-nav')) {
                this.removeLIStateByClass([FOCUSED, SELECTED], [ej2_base_5.closest(trgt, '.e-' + this.getModuleName() + '-wrapper')]);
            }
            if (actionNeeded) {
                switch (e.action) {
                    case RIGHTARROW:
        ...
        MenuBase.prototype.getUlByNavIdx = function (navIdxLen) {
            ...
            if (this.isMenu) {
                var popup = [this.getWrapper()].concat([].slice.call(ej2_base_5.selectAll('.' + POPUP)))[navIdxLen];
                return ej2_base_4.isNullOrUndefined(popup) ? null : ej2_base_5.select('.e-menu-parent', popup);
            }
            else {
        ...
        MenuBase.prototype.closeMenu = function (ulIndex, e, isIterated) {
            ...
            if (this.isMenuVisible()) {
                ...
                var ul_1 = this.isMenu && cnt !== 1 ? ej2_base_5.select('.e-ul', popups[cnt - 2])
                    : ej2_base_5.selectAll('.e-menu-parent', wrapper)[cnt - 1];
                ...
                if (!isClose) {
                    ...
                    beforeCloseArgs = { element: ul_1, parentItem: this.isMenu && ej2_base_6.isBlazor() ? this.getMenuItemModel(item_1, ulIndex) : item_1,
                    ...
                    this.trigger('beforeClose', beforeCloseArgs, function (observedCloseArgs) {
                        ...
                        if (isOpen || _this.isCMenu) {
                            if (_this.isMenu) {
                                popupEle = ej2_base_5.closest(ul_1, '.' + POPUP);
                                if (_this.hamburgerMode) {
                                    popupEle.parentElement.style.minHeight = '';
                                    ej2_base_5.closest(ul_1, '.e-menu-item').setAttribute('aria-expanded', 'false');
                                }
                                _this.unWireKeyboardEvent(popupEle);
                                menu_scroll_1.destroyScroll(ej2_base_4.getInstance(popupEle.children[0], v_scroll_1.VScroll), popupEle.children[0]);
                                popupObj = ej2_base_4.getInstance(popupEle, ej2_popups_1.Popup);
                                popupObj.hide();
                                popupId = popupEle.id;
                                popupObj.destroy();
                                ej2_base_5.detach(popupEle);
                            }
                            else {
                        ...
                        if (isOpen && _this.hamburgerMode && ulIndex && !(submenus.length)) {
                            ...
                            var ele = (e && e.target.classList.contains('e-vscroll'))
                                ? ej2_base_5.closest(e.target, '.e-menu-wrapper') : null;
                            if (ele) {
                        ...
                        else if (isOpen && ej2_base_4.isNullOrUndefined(ulIndex) && _this.navIdx.length) {
                            _this.closeMenu(null, e);
                        }
                            ...
                            _this.navIdx.length !== 0 && ej2_base_5.closest(e.target, '.e-menu-parent.e-control')) {
                            _this.closeMenu(0, e);
                        }
                        else {
                            if (isOpen && (_this.keyType === 'right' || _this.keyType === 'click')) {
                                ...
                                if (!isOpen && _this.hamburgerMode && liElem_1 && liElem_1.getAttribute('aria-expanded') === 'false' &&
                                    ...
                                    if (ej2_base_5.closest(liElem_1, '.e-menu-parent.e-control')) {
                                        _this.navIdx = [];
                                    }
                                    else {
                                        _this.navIdx.pop();
        ...
        MenuBase.prototype.getMenuItemModel = function (item, level) {
            ...
            if (ej2_base_4.isNullOrUndefined(level)) {
                level = 0;
            }
        ...
        MenuBase.prototype.getPopups = function () {
            ...
            [].slice.call(document.querySelectorAll('.' + POPUP)).forEach(function (elem) {
                if (!ej2_base_4.isNullOrUndefined(elem.querySelector('.' + ITEM)) && _this.getIndex(elem.querySelector('.' + ITEM).id, true).length) {
                    popups.push(elem);
                }
            });
            return popups;
        ...
        MenuBase.prototype.canOpen = function (target) {
            ...
            if (this.filter) {
                ...
                for (var i = 0, len = filter.length; i < len; i++) {
                    if (ej2_base_5.closest(target, '.' + filter[i])) {
                        canOpen = true;
                        break;
                    }
                }
        ...
        MenuBase.prototype.openMenu = function (li, item, top, left, e, target) {
            ...
            if (ej2_base_4.isNullOrUndefined(top)) {
                top = -1;
            }
            if (ej2_base_4.isNullOrUndefined(left)) {
                left = -1;
            }
            if (li) {
                this.uList = this.createItems(item[this.getField('children', this.navIdx.length - 1)]);
                if (!this.isMenu && ej2_base_4.Browser.isDevice) {
                ...
                if (this.isMenu) {
                    ...
                    if (this.hamburgerMode) {
                        ...
                        if (this.cssClass) {
                            ej2_base_5.addClass([this.popupWrapper], this.cssClass.split(' '));
                        }
                        this.popupObj.hide();
                    }
                ...
                this.uList.style.zIndex = ej2_popups_1.getZindexPartial(target ? target : this.element).toString();
                this.triggerBeforeOpen(li, this.uList, item, e, top, left, 'none');
            }
            if (this.isMenu && this.template && ej2_base_6.isBlazor()) {
                var menuTemplateId = this.element.id + TEMPLATE_PROPERTY;
                if (Object.keys(ej2_base_6.blazorTemplates).length) {
                    var itemFromBlazorTemplate = ej2_base_6.blazorTemplates[menuTemplateId];
                    this.tempItem = this.tempItem.concat(itemFromBlazorTemplate);
                    ej2_base_6.blazorTemplates[menuTemplateId] = this.tempItem;
                }
                ej2_base_6.updateBlazorTemplate(menuTemplateId, TEMPLATE_PROPERTY, this);
            }
        };
        ...
        MenuBase.prototype.generatePopup = function (popupWrapper, ul, li, isNestedOrVertical) {
            var _this = this;
            var popupObj = new ej2_popups_1.Popup(popupWrapper, {
                ...
                content: ul,
                open: function () {
                    var scrollEle = ej2_base_5.select('.e-menu-vscroll', popupObj.element);
                    if (scrollEle) {
                        scrollEle.style.height = 'inherit';
                        scrollEle.style.maxHeight = '';
                    }
                    var ul = ej2_base_5.select('.e-ul', popupObj.element);
        ...
        MenuBase.prototype.createHeaderContainer = function (wrapper) {
            ...
            var tempTitle = (this.enableHtmlSanitizer) ? ej2_base_6.SanitizeHtmlHelper.sanitize(this.title) : this.title;
        ...
        MenuBase.prototype.callFit = function (element, x, y, top, left) {
            return ej2_popups_1.fit(element, null, { X: x, Y: y }, { top: top, left: left });
        };
        MenuBase.prototype.triggerBeforeOpen = function (li, ul, item, e, top, left, type) {
            var _this = this;
            var items = li ? item[this.getField('children', this.navIdx.length - 1)] : this.items;
            var eventArgs = {
                element: ul, items: items, parentItem: this.isMenu && ej2_base_6.isBlazor() ? this.getMenuItemModel(item, this.navIdx.length - 1) :
                    ...
                    case 'menu':
                        ...
                        if (!_this.hamburgerMode) {
                            ...
                            if (_this.enableScrolling) {
                                menu_scroll_1.addScrolling(_this.createElement, _this.popupWrapper, _this.uList, 'vscroll', _this.enableRtl);
                            }
                        ...
                        if (!_this.hamburgerMode && !_this.left && !_this.top) {
                            ...
                            collide = ej2_popups_1.isCollide(_this.popupWrapper, null, _this.left, _this.top);
                            if ((_this.isNestedOrVertical || _this.enableRtl) && (collide.indexOf('right') > -1
                                || collide.indexOf('left') > -1)) {
                                _this.popupObj.collision.X = 'none';
                                var offWidth = ej2_base_5.closest(_this.lItem, '.e-' + _this.getModuleName() + '-wrapper').offsetWidth;
                                _this.left =
                                    _this.enableRtl ? ej2_popups_1.calculatePosition(_this.lItem, _this.isNestedOrVertical ? 'right' : 'left', 'top').left
                ...
                if (menuType !== 'hamburger') {
                    if (observedOpenArgs.cancel) {
                        if (_this.isMenu) {
                            ...
                            ej2_base_5.detach(_this.popupWrapper);
                        }
                        ...
                        if (_this.isMenu) {
                            if (_this.hamburgerMode) {
                                ...
                                ej2_base_5.rippleEffect(_this.popupWrapper, { selector: '.' + ITEM });
                                _this.popupWrapper.style.left = _this.left + 'px';
                                _this.popupWrapper.style.top = _this.top + 'px';
        ...
        MenuBase.prototype.checkScrollOffset = function (e) {
            ...
            if (wrapper.children[0].classList.contains('e-menu-hscroll') && this.navIdx.length === 1) {
                var trgt = ej2_base_4.isNullOrUndefined(e) ? this.element : ej2_base_5.closest(e.target, '.' + ITEM);
                var offsetEle = ej2_base_5.select('.e-hscroll-bar', wrapper);
        ...
        MenuBase.prototype.createItems = function (items) {
            ...
            var fields = this.getFields(level);
            if (ej2_base_6.isBlazor() && this.template && items.length && items[0].properties) {
                var itemsObj_1 = [];
                items.forEach(function (item, index) {
                    itemsObj_1.push({});
                    itemsObj_1[index][fields.text] = item[fields.text];
                    if (!item[fields.id]) {
                        item[fields.id] = ej2_base_4.getUniqueID('menuitem');
                    }
            ...
            var listBaseOptions = {
                ...
                itemCreating: function (args) {
                    if (!args.curData[args.fields[fields.id]]) {
                        args.curData[args.fields[fields.id]] = ej2_base_4.getUniqueID('menuitem');
                    }
            ...
            var ul = ej2_lists_1.ListBase.createList(this.createElement, items, listBaseOptions, !this.template, this);
        ...
        MenuBase.prototype.moverHandler = function (e) {
            ...
            var wrapper = cli ? ej2_base_5.closest(cli, '.e-' + this.getModuleName() + '-wrapper') : this.getWrapper();
            ...
            if (cli && ej2_base_5.closest(cli, '.e-' + this.getModuleName() + '-wrapper') && !isDifferentElem) {
            ...
            if (this.isMenu) {
                if (!this.showItemOnClick && (trgt.parentElement !== wrapper && !ej2_base_5.closest(trgt, '.e-' + this.getModuleName() + '-popup'))
        ...
        MenuBase.prototype.removeStateWrapper = function () {
            if (this.liTrgt) {
                var wrapper = ej2_base_5.closest(this.liTrgt, '.e-menu-vscroll');
        ...
        MenuBase.prototype.removeLIStateByClass = function (classList, element) {
            ...
            var _loop_1 = function (i) {
                classList.forEach(function (className) {
                    li = ej2_base_5.select('.' + className, element[i]);
                    if (li) {
        ...
        MenuBase.prototype.menuHeaderClickHandler = function (e) {
            if (ej2_base_5.closest(e.target, '.e-menu-wrapper').querySelector('ul.e-menu-parent').id !== this.element.id) {
                return;
            }
        ...
        MenuBase.prototype.clickHandler = function (e) {
            if (this.isTapHold) {
                ...
                var regex = new RegExp('-ej2menu-(.*)-popup');
                var cliWrapper = cli ? ej2_base_5.closest(cli, '.e-' + this.getModuleName() + '-wrapper') : null;
                var isInstLI = cli && cliWrapper && (this.isMenu ? this.getIndex(cli.id, true).length > 0
                    : wrapper.firstElementChild.id === cliWrapper.firstElementChild.id);
                if (ej2_base_4.Browser.isDevice && this.isMenu) {
                    this.removeLIStateByClass([FOCUSED], [wrapper].concat(this.getPopups()));
                ...
                if (isInstLI && (e.type === 'mouseover' || ej2_base_4.Browser.isDevice || this.showItemOnClick)) {
                    ...
                    if (cli.classList.contains(HEADER)) {
                        ...
                        if (!cli.classList.contains(SEPARATOR)) {
                            ...
                            if (this.isMenu || !ej2_base_4.Browser.isDevice) {
                                var culIdx = this.isMenu ? Array.prototype.indexOf.call([wrapper].concat(this.getPopups()), ej2_base_5.closest(cul, '.' + 'e-' + this.getModuleName() + '-wrapper'))
                    ...
                    if (this.isMenu && trgt.tagName === 'DIV' && this.navIdx.length && ej2_base_5.closest(trgt, '.e-menu-vscroll')) {
                        var popupEle = ej2_base_5.closest(trgt, '.' + POPUP);
        ...
        MenuBase.prototype.afterCloseMenu = function (e) {
            ...
            if (this.showSubMenu) {
                if (this.showItemOnClick && this.navIdx.length === 0) {
                    isHeader = ej2_base_5.closest(e.target, '.e-menu-parent.e-control');
                }
                else {
                    isHeader = ej2_base_5.closest(this.element, '.e-menu-parent.e-control');
                }
                var idx = this.navIdx.concat(this.cliIdx);
                var item = this.getItem(idx);
                if (item && item[this.getField('children', idx.length - 1)] &&
                    item[this.getField('children', idx.length - 1)].length) {
                    if (e.type === 'mouseover' || (ej2_base_4.Browser.isDevice && this.isMenu)) {
        ...
        MenuBase.prototype.getLI = function (elem) {
            ...
            return ej2_base_5.closest(elem, 'li.e-menu-item');
        };
        ...
        MenuBase.prototype.onPropertyChanged = function (newProp, oldProp) {
            ...
            var _loop_2 = function (prop) {
                switch (prop) {
                    case 'cssClass':
                        if (oldProp.cssClass) {
                            ej2_base_5.removeClass([wrapper], oldProp.cssClass.split(' '));
                        }
                        if (newProp.cssClass) {
                            ej2_base_5.addClass([wrapper], newProp.cssClass.split(' '));
                        }
                        break;
                    case 'enableRtl':
                    ...
                    case 'enableScrolling':
                        if (newProp.enableScrolling) {
                            ...
                            if (this_1.element.classList.contains('e-vertical')) {
                                menu_scroll_1.addScrolling(this_1.createElement, wrapper, this_1.element, 'vscroll', this_1.enableRtl);
                            }
                            else {
                                menu_scroll_1.addScrolling(this_1.createElement, wrapper, this_1.element, 'hscroll', this_1.enableRtl);
                            }
                            this_1.getPopups().forEach(function (wrapper) {
                                ul_2 = ej2_base_5.select('.e-ul', wrapper);
                                menu_scroll_1.addScrolling(_this.createElement, wrapper, ul_2, 'vscroll', _this.enableRtl);
                            });
                        }
                        else {
                            var ul_3 = wrapper.children[0];
                            if (this_1.element.classList.contains('e-vertical')) {
                                menu_scroll_1.destroyScroll(ej2_base_4.getInstance(ul_3, v_scroll_1.VScroll), ul_3);
                            }
                            else {
                                menu_scroll_1.destroyScroll(ej2_base_4.getInstance(ul_3, h_scroll_1.HScroll), ul_3);
                            }
                    ...
                    case 'items': {
                        ...
                        if (!Object.keys(oldProp.items).length) {
                            ...
                            for (var i = 1, count = wrapper.childElementCount; i < count; i++) {
                                ej2_base_5.detach(wrapper.lastElementChild);
                            }
                            if (this_1.isMenu && ej2_base_6.isBlazor()) {
        ...
        MenuBase.prototype.removeItem = function (item, navIdx, idx) {
            ...
            if (navIdx.length < uls.length) {
                ej2_base_5.detach(uls[navIdx.length].children[idx]);
            }
        };
        MenuBase.prototype.unWireEvents = function (targetSelctor) {
            ...
            if (targetSelctor) {
                ...
                var targetElems = ej2_base_5.selectAll(targetSelctor);
                for (var i = 0, len = targetElems.length; i < len; i++) {
                    target = targetElems[i];
                    if (this.isMenu) {
                        ej2_base_2.EventHandler.remove(target, 'click', this.menuHeaderClickHandler);
                    }
                    else {
                        if (ej2_base_4.Browser.isIos) {
                ...
                if (!this.isMenu) {
                    ej2_base_2.EventHandler.remove(this.targetElement, 'scroll', this.scrollHandler);
                    for (var _i = 0, _a = ej2_popups_2.getScrollableParent(this.targetElement); _i < _a.length; _i++) {
                        var parent_2 = _a[_i];
            ...
            if (!ej2_base_4.Browser.isDevice) {
                ej2_base_2.EventHandler.remove(this.isMenu ? document : wrapper, 'mouseover', this.delegateMoverHandler);
                ej2_base_2.EventHandler.remove(document, 'mousedown', this.delegateMouseDownHandler);
            }
            ej2_base_2.EventHandler.remove(document, 'click', this.delegateClickHandler);
            this.unWireKeyboardEvent(wrapper);
            this.rippleFn();
        };
        MenuBase.prototype.unWireKeyboardEvent = function (element) {
            var keyboardModule = ej2_base_4.getInstance(element, ej2_base_2.KeyboardEvents);
            if (keyboardModule) {
        ...
        MenuBase.prototype.getWrapper = function () {
            return ej2_base_5.closest(this.element, '.e-' + this.getModuleName() + '-wrapper');
        };
        ...
        MenuBase.prototype.insertItems = function (items, text, isUniqueId, isAfter) {
            ...
            for (var i = 0; i < items.length; i++) {
                ...
                if (navIdx.length < uls.length) {
                    ...
                    var ul = this.isMenu ? ej2_base_5.select('.e-menu-parent', uls[navIdx.length]) : uls[navIdx.length];
            ...
            if (wrapper) {
                ...
                if (!this.isMenu) {
                    ...
                    if (this.clonedElement.tagName === 'EJS-CONTEXTMENU') {
                        ej2_base_5.addClass([this.clonedElement], ['e-control', 'e-lib', 'e-' + this.getModuleName()]);
                        ...
                        if (document.getElementById(this.clonedElement.id)) {
                            ...
                            ej2_base_5.append([].slice.call(this.clonedElement.children), this.element);
                            ej2_base_5.detach(this.clonedElement);
        ...
        __decorate([
            ej2_base_5.Complex({ itemId: 'id', text: 'text', parentId: 'parentId', iconCss: 'iconCss', url: 'url', separator: 'separator', children: 'items' }, FieldSettings)
        ], MenuBase.prototype, "fields", void 0);
        __decorate([
            ej2_base_4.Collection([], MenuItem)
        ], MenuBase.prototype, "items", void 0);
        __decorate([
            ej2_base_5.Complex({ duration: 400, easing: 'ease', effect: 'SlideDown' }, MenuAnimationSettings)
