    ...
    var Toolbar = (function (_super) {
        ...
        Toolbar.prototype.destroy = function () {
            ...
            this.tempId.forEach(function (ele) {
                if (!ej2_base_4.isNullOrUndefined(_this.element.querySelector(ele))) {
            ...
            if (this.cssClass) {
                ej2_base_2.removeClass([this.element], this.cssClass.split(' '));
            }
        ...
        Toolbar.prototype.docKeyDown = function (e) {
            ...
            var popCheck = !ej2_base_4.isNullOrUndefined(this.popObj) && ej2_base_2.isVisible(this.popObj.element) && this.overflowMode !== 'Extended';
        ...
        Toolbar.prototype.docEvent = function (e) {
            ...
            if (this.popObj && ej2_base_2.isVisible(this.popObj.element) && !popEle && this.overflowMode === 'Popup') {
                this.popObj.hide({ name: 'FadeOut', duration: 100 });
            }
        };
        ...
        Toolbar.prototype.destroyItems = function () {
            if (this.element) {
                [].slice.call(this.element.querySelectorAll('.' + CLS_ITEM)).forEach(function (el) { ej2_base_2.detach(el); });
            }
        ...
        Toolbar.prototype.disable = function (value) {
            ...
            if (this.popObj) {
                if (ej2_base_2.isVisible(this.popObj.element) && this.overflowMode !== 'Extended') {
                    this.popObj.hide();
                }
        ...
        Toolbar.prototype.eleContains = function (el) {
            return el.classList.contains(CLS_SEPARATOR) || el.classList.contains(CLS_DISABLE) || el.getAttribute('disabled') || el.classList.contains(CLS_HIDDEN) || !ej2_base_2.isVisible(el);
        };
        ...
        Toolbar.prototype.clickHandler = function (e) {
            ...
            if (itemObj && !ej2_base_4.isNullOrUndefined(itemObj.click)) {
                this.trigger('items[' + this.tbarEle.indexOf(clst) + '].click', eventArgs);
            }
            if (!eventArgs.cancel) {
                this.trigger('clicked', eventArgs, function (clickedArgs) {
                    if (!ej2_base_4.isNullOrUndefined(_this.popObj) && isPopupElement && !clickedArgs.cancel && _this.overflowMode === 'Popup' &&
        ...
        Toolbar.prototype.initialize = function () {
            ...
            if (ej2_base_5.Browser.info.name !== 'msie' || this.height !== 'auto' || this.overflowMode === 'MultiRow') {
        ...
        Toolbar.prototype.changeOrientation = function () {
            ...
            if (this.isVertical) {
                ...
                ej2_base_3.setStyleAttribute(this.element, { 'height': ej2_base_4.formatUnit(this.height), 'width': ej2_base_4.formatUnit(this.width) });
            }
            this.destroyMode();
        ...
        Toolbar.prototype.initScroll = function (element, innerItems) {
            if (!this.scrollModule && this.checkOverflow(element, innerItems[0])) {
                ...
                if (this.isVertical) {
                    ...
                    this.scrollModule = new h_scroll_1.HScroll({ scrollStep: this.scrollStep, enableRtl: this.enableRtl }, innerItems[0]);
                }
            ...
            if (ele && ele.children.length > 0) {
                ...
                switch (this.overflowMode) {
                    ...
                    case 'MultiRow':
                        ...
                        if (ej2_base_5.Browser.info.name === 'msie' || ele.style.height !== 'auto') {
        ...
        Toolbar.prototype.pushingPoppedEle = function (tbarObj, popupPri, ele, eleHeight, sepHeight) {
            ...
            poppedEle.forEach(function (el, index) {
                ...
                if (el.classList.contains(CLS_SEPARATOR)) {
                    ej2_base_3.setStyleAttribute(el, { display: '', height: sepHeight + 'px' });
                }
                else {
        ...
        Toolbar.prototype.popupInit = function (element, ele) {
            if (!this.popObj) {
                ...
                if (this.isExtendedOpen) {
                    ...
                    popupNav.classList.add(CLS_TBARNAVACT);
                    ej2_base_2.classList(popupNav.firstElementChild, [CLS_POPUPICON], [CLS_POPUPDOWN]);
        ...
        Toolbar.prototype.popupOpen = function (e) {
            ...
            if (!this.isVertical && ((window.innerHeight + scrollVal) < popupElePos) && (this.element.offsetTop < popupEle.offsetHeight)) {
                ...
                ej2_base_3.setStyleAttribute(popObj.element, { maxHeight: (tbEleData.top + this.element.offsetHeight) + 'px', bottom: 0, visibility: '' });
            }
            if (popObj) {
        ...
        Toolbar.prototype.checkPriority = function (ele, inEle, eleWidth, pre) {
            ...
            for (var i = len - 1; i >= 0; i--) {
                ...
                if (checkClass(inEle[i], [CLS_POPPRI]) && popPriority) {
                    ...
                    if (this.isVertical) {
                        ej2_base_3.setStyleAttribute(inEle[i], { display: 'none', minHeight: eleWid_1 + 'px' });
                    }
                    else {
        ...
        Toolbar.prototype.popupRefresh = function (popupEle, destroy) {
            ...
            [].slice.call(popupEle.children).forEach(function (el) {
                ...
                ej2_base_3.setStyleAttribute(el, { 'position': '' });
            });
        ...
        Toolbar.prototype.popupEleRefresh = function (width, popupEle, destroy) {
            ...
            var _loop_1 = function (el) {
                ...
                if (elWidth < width || destroy) {
                    ej2_base_3.setStyleAttribute(el, { minWidth: '', height: '', minHeight: '' });
        ...
        Toolbar.prototype.enableItems = function (items, isEnable) {
            ...
            if (!ej2_base_4.isNullOrUndefined(len) && len >= 1) {
                for (var a = 0, element = [].slice.call(elements); a < len; a++) {
                    var itemElement = element[a];
                    if (typeof (itemElement) === 'number') {
                        ele = this.getElementByIndex(itemElement);
                        if (ej2_base_4.isNullOrUndefined(ele)) {
                            return;
                        }
                        else {
                            elements[a] = ele;
        ...
        Toolbar.prototype.addItems = function (items, index) {
            ...
            if (ej2_base_4.isNullOrUndefined(itemsDiv)) {
            ...
            for (var _i = 0, items_1 = items; _i < items_1.length; _i++) {
                ...
                if (this.tbarEle.length >= index && innerItems.length >= 0) {
                    ...
                    if (!this.tbarAlign && itemAgn !== 'Left') {
                        ...
                        innerItems = ej2_base_3.selectAll('.' + CLS_ITEMS, this.element);
        ...
        Toolbar.prototype.templateRender = function (templateProp, innerEle, item, index) {
            ...
            if (typeof (templateProp) === 'string' || !isComponent) {
                ...
                try {
                    if (typeof (templateProp) === 'object' && !ej2_base_4.isNullOrUndefined(templateProp.tagName)) {
                        ...
                        ele.style.display = '';
                        if (!ej2_base_4.isNullOrUndefined(tempStr)) {
        ...
        Toolbar.prototype.buttonRendering = function (item, innerEle) {
            ...
            if (textStr) {
                btnTxt.innerHTML = this.enableHtmlSanitizer ? ej2_base_5.SanitizeHtmlHelper.sanitize(textStr) : textStr;
            ...
            var btnObj = new ej2_buttons_1.Button({ iconCss: iconCss, iconPosition: iconPos });
        ...
        Toolbar.prototype.renderSubComponent = function (item, index) {
            ...
            var tempDom = this.createElement('div', {
                innerHTML: this.enableHtmlSanitizer ? ej2_base_5.SanitizeHtmlHelper.sanitize(item.tooltipText) : item.tooltipText
            });
            if (!this.tbarEle) {
                this.tbarEle = [];
            }
        ...
        Toolbar.prototype.resize = function () {
            ...
            if (!checkOverflow) {
                ...
                if (!ej2_base_4.isNullOrUndefined(multirowele)) {
        ...
        Toolbar.prototype.hideItem = function (index, value) {
            ...
            if (isElement) {
                ...
                var innerItems_1 = [].slice.call(ej2_base_3.selectAll('.' + CLS_ITEM, this.element));
                ele = innerItems_1[eleIndex];
            }
            if (ele) {
                value ? ele.classList.add(CLS_HIDDEN) : ele.classList.remove(CLS_HIDDEN);
                if (value && ej2_base_4.isNullOrUndefined(this.element.getAttribute('tabindex')) && !ele.classList.contains(CLS_SEPARATOR)) {
                    if (ej2_base_4.isNullOrUndefined(ele.firstElementChild.getAttribute('tabindex'))) {
                        ele.firstElementChild.setAttribute('tabindex', '-1');
                        var innerItems_2 = [].slice.call(ej2_base_3.selectAll('.' + CLS_ITEM, this.element));
                        if (isElement) {
                ...
                else if (ej2_base_4.isNullOrUndefined(this.element.getAttribute('tabindex')) && !ele.classList.contains(CLS_SEPARATOR)) {
                    initIndex = 0;
                    var setFlag = false;
                    ...
                    while (initELe) {
                        if (!initELe.classList.contains(CLS_SEPARATOR)) {
                            if (ej2_base_4.isNullOrUndefined(initELe.firstElementChild.getAttribute('tabindex'))) {
