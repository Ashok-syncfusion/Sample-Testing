...
$btn-focus-outline-round: $white 1px solid !default;
...
//endinfo
//round
$btn-round-focus-color: $white !default;
$btn-round-active-color: $white !default;
...
$btn-flat-primary-disabled-color: rgba($btn-flat-color, .65) !default;
...
$btn-flat-success-disabled-color: rgba($btn-flat-success-color, .65) !default;
...
$btn-flat-info-disabled-color: rgba($btn-flat-info-color, .65) !default;
...
$btn-flat-warning-disabled-color: rgba($btn-flat-warning-color, .65) !default;
...
$btn-flat-danger-disabled-color: rgba($btn-flat-danger-color, .65) !default;
//endflatdanger
//outlineprimary
$btn-outline-primary-disabled-color: rgba($primary, .65) !default;
...
//endoutlineprimay
//outlinesuccess
$btn-outline-success-disabled-color: rgba($success, .65) !default;
...
//endoutlinesuccess
//outlineinfo
$btn-outline-info-disabled-color: rgba($info, .65) !default;
$btn-outline-info-disabled-border-color: rgba($btn-info-bgcolor, .65) !default;
//endoutlineinfo
//outlinewarning
$btn-outline-warning-disabled-color: rgba($warning, .65) !default;
$btn-outline-warning-disabled-border-color: rgba($btn-warning-bgcolor, .65) !default;
//endoutlinewarning
//outlinedanger
$btn-outline-danger-disabled-color: rgba($danger, .65) !default;
...
$btn-bigger-small-icon-font-size: $text-sm !default;
$btn-round-small-height: 26px !default;
$btn-round-small-width: 26px !default;
$btn-round-height: 30px !default;
$btn-round-width: 30px !default;
...
$btn-round-icon-line-height: $leading-none !default;
$btn-small-round-icon-line-height: $leading-none !default;
$btn-bigger-round-icon-line-height: $leading-none !default;
$btn-bigger-small-round-icon-line-height: $leading-none !default;
$btn-text-line-height: $leading-none !default;
$btn-bigger-text-line-height: $leading-none !default;
$btn-small-text-line-height: $leading-none !default;
$btn-bigger-small-text-line-height: $leading-none !default;
$btn-padding: 7px 11px !default;
$btn-small-padding: 6px 7px !default;
$btn-bigger-padding: 10px 15px !default;
$btn-bigger-small-padding: 9px 13px !default;
$btn-icon-padding: 7px 11px !default;
$btn-small-icon-padding: 6px 7px !default;
$btn-bigger-icon-padding: 10px 15px !default;
$btn-bigger-small-icon-padding: 9px 13px !default;
...
$btn-focus-box-shadow: $shadow-focus-ring2 !default;
//endsize
