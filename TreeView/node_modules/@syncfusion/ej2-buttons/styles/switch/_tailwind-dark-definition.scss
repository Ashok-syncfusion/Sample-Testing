...
$switch-handle-margin-left: -19px !default;
...
$switch-inner-bg: $content-bg-color-alt3 !default;
...
$switch-on-off-disabled-bg-color: $content-bg-color-alt3 !default;
$switch-on-off-disabled-bg-color-opacity: .5 !default;
$switch-handle-disabled-bg-color: $content-bg-color !default;
...
$switch-hover-border: $content-bg-color !default;
...
$switch-on-disabled-bg-color: $content-bg-color-alt3 !default;
...
$switch-handle-off-hover-bg-color: $content-bg-color !default;
...
$switch-bigger-handle-active-left-rtl: 23px !default;
$switch-bigger-font-size: $text-sm !default;
$switch-bigger-on-text-indent: -18px !default;
$switch-bigger-off-text-indent: 20px !default;
...
$switch-bigger-small-handle-width: 16px !default;
$switch-bigger-small-handle-height: 16px !default;
$switch-bigger-small-handle-active-left: 100% !default;
$switch-bigger-small-handle-margin-left: -19px !default;
$switch-bigger-small-handle-active-left-rtl: 19px !default;
