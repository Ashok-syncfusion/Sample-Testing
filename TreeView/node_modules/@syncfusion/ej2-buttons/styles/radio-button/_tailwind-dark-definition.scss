...
$radio-btn-bigger-height: 18px !default;
...
$radio-btn-bigger-width: 18px !default;
...
$radio-btn-checked-border-color: $border-light !default;
...
$radio-btn-hover-check-border-color: $content-bg-color !default;
...
$radio-btn-small-icon-left: 5px !default;
$radio-btn-small-icon-top: 5px !default;
...
$radio-btn-bigger-small-icon-height: 6px !default;
$radio-btn-bigger-small-icon-width: 6px !default;
