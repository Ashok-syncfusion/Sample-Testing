define(["require", "exports", "../../src/treeview/treeview"], function (require, exports, treeview_1) {
    ...
    var hierarchicalData = [
        {
            nodeId: '01', nodeText: 'Music', icon: 'folder', isSelected: true,
            nodeChild: [
    ...
    var tree1 = new treeview_1.TreeView({
        fields: { dataSource: hierarchicalData, id: 'nodeId', text: 'nodeText', child: 'nodeChild', iconCss: 'icon', imageUrl: 'image', selected: 'isSelected' },
        sortOrder: 'Ascending',
        fullRowSelect: false,
        showCheckBox: true,
        enableRtl: true
