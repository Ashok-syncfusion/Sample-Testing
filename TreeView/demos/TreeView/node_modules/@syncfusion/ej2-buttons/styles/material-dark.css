...
.e-css.e-btn.e-flat.e-primary:focus {
  background-color: rgba(255, 128, 171, 0.12);
  border-color: transparent;
  color: #ff80ab;
}
...
.e-css.e-btn.e-flat.e-primary.e-active {
  background-color: rgba(255, 128, 171, 0.24);
  border-color: transparent;
  color: #ff80ab;
}
...
.e-css.e-checkbox-wrapper .e-ripple-element {
  background: rgba(255, 128, 171, 0.26);
}
...
.e-css.e-switch-wrapper.e-rtl.e-focus .e-switch-on {
  background-color: rgba(255, 128, 171, 0.54);
}
...
.e-chip-list.e-selection .e-chip:active {
  background-color: rgba(255, 128, 171, 0.32);
  border-color: transparent;
  color: #fff;
}
...
.e-chip-list.e-selection .e-chip:active .e-chip-avatar {
  background-color: rgba(255, 189, 211, 0.32);
  color: #fff;
}
...
.e-chip-list .e-chip.e-primary.e-outline:hover {
  background-color: rgba(255, 128, 171, 0.18);
  border-color: #ff80ab;
  color: #ff80ab;
}
...
.e-chip-list .e-chip.e-danger.e-outline:hover {
  background-color: rgba(255, 102, 82, 0.18);
  border-color: #ff6652;
  color: #ff6652;
}
