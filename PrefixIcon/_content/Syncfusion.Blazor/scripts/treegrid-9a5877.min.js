 ...
 */var Column=function(){function Column(options){/**
 ...
 * Configures the filtering behavior of the TreeGrid.
 */var SearchSettings=function(_super){__extends$5(SearchSettings,_super);function SearchSettings(){return _super!==null&&_super.apply(this,arguments)||this;}__decorate$3([sf.base.Property()],SearchSettings.prototype,"fields",void 0);__decorate$3([sf.base.Property(false)],SearchSettings.prototype,"ignoreCase",void 0);__decorate$3([sf.base.Property('contains')],SearchSettings.prototype,"operator",void 0);__decorate$3([sf.base.Property()],SearchSettings.prototype,"key",void 0);__decorate$3([sf.base.Property()],SearchSettings.prototype,"hierarchyMode",void 0);return SearchSettings;}(sf.base.ChildProperty);var __extends$6=undefined&&undefined.__extends||function(){var _extendStatics6=function extendStatics(d,b){_extendStatics6=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(d,b){d.__proto__=b;}||function(d,b){for(var p in b){if(b.hasOwnProperty(p))d[p]=b[p];}};return _extendStatics6(d,b);};return function(d,b){_extendStatics6(d,b);function __(){this.constructor=d;}d.prototype=b===null?Object.create(b):(__.prototype=b.prototype,new __());};}();var __decorate$4=undefined&&undefined.__decorate||function(decorators,target,key,desc){var c=arguments.length,r=c<3?target:desc===null?desc=Object.getOwnPropertyDescriptor(target,key):desc,d;if((typeof Reflect==="undefined"?"undefined":_typeof(Reflect))==="object"&&typeof Reflect.decorate==="function")r=Reflect.decorate(decorators,target,key,desc);else for(var i=decorators.length-1;i>=0;i--){if(d=decorators[i])r=(c<3?d(r):c>3?d(target,key,r):d(target,key))||r;}return c>3&&r&&Object.defineProperty(target,key,r),r;};/**
 * Configures the selection behavior of the TreeGrid.
 */var SelectionSettings=function(_super){__extends$6(SelectionSettings,_super);function SelectionSettings(){return _super!==null&&_super.apply(this,arguments)||this;}__decorate$4([sf.base.Property('Row')],SelectionSettings.prototype,"mode",void 0);__decorate$4([sf.base.Property('Flow')],SelectionSettings.prototype,"cellSelectionMode",void 0);__decorate$4([sf.base.Property('Single')],SelectionSettings.prototype,"type",void 0);__decorate$4([sf.base.Property(false)],SelectionSettings.prototype,"persistSelection",void 0);__decorate$4([sf.base.Property('Default')],SelectionSettings.prototype,"checkboxMode",void 0);__decorate$4([sf.base.Property(false)],SelectionSettings.prototype,"checkboxOnly",void 0);__decorate$4([sf.base.Property(true)],SelectionSettings.prototype,"enableToggle",void 0);return SelectionSettings;}(sf.base.ChildProperty);/**
...
return this.columnModel;};/**
     ...
     * @returns {void}
     */TreeGrid.prototype.expandRow=function(row,record){var _this=this;record=this.getCollapseExpandRecords(row,record);if(!sf.base.isNullOrUndefined(row)&&row.cells[0].classList.contains('e-lastrowcell')){this.lastRowBorder(row,false);}var args={data:record,row:row,cancel:false};this.trigger(expanding,args,function(expandingArgs){if(!expandingArgs.cancel){_this.expandCollapse('expand',row,record);var children='Children';if(!(isRemoteData(_this)&&!isOffline(_this))&&(!isCountRequired(_this)||!sf.base.isNullOrUndefined(record[children]))){var collapseArgs={data:record,row:row};_this.setHeightForFrozenContent();_this.trigger(expanded,collapseArgs);}}});};TreeGrid.prototype.setHeightForFrozenContent=function(){if(this.grid.getFrozenColumns()>0){this.grid.contentModule.refreshScrollOffset();}};TreeGrid.prototype.getCollapseExpandRecords=function(row,record){if(this.allowPaging&&this.pageSettings.pageSizeMode==='All'&&this.isExpandAll&&sf.base.isNullOrUndefined(record)&&!isRemoteData(this)){record=this.flatData.filter(function(e){return e.hasChildRecords;});}else if(sf.base.isNullOrUndefined(record)){record=this.grid.getCurrentViewRecords()[row.rowIndex];}return record;};/**
 ...
 */var RowDropSettings$1=function(_super){__extends$12(RowDropSettings$$1,_super);function RowDropSettings$$1(){return _super!==null&&_super.apply(this,arguments)||this;}__decorate$10([sf.base.Property()],RowDropSettings$$1.prototype,"targetID",void 0);return RowDropSettings$$1;}(sf.base.ChildProperty);/**
 * Models export
 ...
 *
 * @hidden
 */var Page$1=function(){function Page$$1(parent){sf.grids.Grid.Inject(sf.grids.Page);this.parent=parent;this.addEventListener();}/**
     * @hidden
     * @returns {void}
 ...
 *
 * @hidden
 */var Toolbar$1=function(){function Toolbar$$1(parent){sf.grids.Grid.Inject(sf.grids.Toolbar);this.parent=parent;this.addEventListener();}/**
     * For internal use only - Get the module name.
     *
     * @private
 ...
 *
 * @hidden
 */var Sort$1=function(){function Sort$$1(grid){sf.grids.Grid.Inject(sf.grids.Sort);this.parent=grid;this.taskIds=[];this.flatSortedData=[];this.storedIndex=-1;this.isSelfReference=!sf.base.isNullOrUndefined(this.parent.parentIdMapping);this.addEventListener();}/**
     * For internal use only - Get the module name.
     *
     * @private
 ...
 *
 * @hidden
 */var ContextMenu$1=function(){function ContextMenu$$1(parent){sf.grids.Grid.Inject(sf.grids.ContextMenu);this.parent=parent;this.addEventListener();}/**
     * @hidden
     * @returns {void}
 ...
 *
 * @hidden
 */var CommandColumn$1=function(){function CommandColumn$$1(parent){sf.grids.Grid.Inject(sf.grids.CommandColumn);this.parent=parent;}/**
     * For internal use only - Get the module name.
     *
     * @private
 ...
 *
 * @hidden
 */var DetailRow$1=function(){function DetailRow$$1(parent){sf.grids.Grid.Inject(sf.grids.DetailRow);this.parent=parent;this.addEventListener();}/**
     * @hidden
     */ /**
     * For internal use only - Get the module name.
     *
