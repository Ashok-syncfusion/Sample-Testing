...
window.sfBlazor.CircularGauge = function () {
  ...
  var SfCircularGauge = function () {
    ...
    SfCircularGauge.prototype.gaugeOnMouseDown = function (e) {
      ...
      var targetId = e.target.id;
      this.dotNetRef.invokeMethodAsync('TriggerMouseDownEvent', e.pageX, e.pageY);
    ...
    SfCircularGauge.prototype.gaugeOnMouseMove = function (e) {
      ...
      if (this.options.enableTooltip) {
        ...
        if ((targetElementId.indexOf('Annotation') !== -1 || parentTargetId.indexOf('Annotation') !== -1) && !sf.base.isNullOrUndefined(this.options.tooltipType) && this.options.tooltipType.indexOf('Annotation') !== -1) {
          ...
          this.dotNetRef.invokeMethodAsync('TriggerTooltipEvent', e.pageX + annotElementWidth / 2, e.pageY, axisIndex, pointerIndex, isRange, isPointer, isAnnotation, rect);
        } else {
    ...
    SfCircularGauge.prototype.gaugeOnMouseEnd = function (e) {
      if (e.type == 'mouseup') {
        this.dotNetRef.invokeMethodAsync('TriggerMouseUpEvent', e.pageX, e.pageY);
      } else {
        this.dotNetRef.invokeMethodAsync('TriggerMouseLeaveEvent', e.pageX, e.pageY);
      }
        ...
        progress: function progress(args) {
          ...
          if (options.isClockWise) {
            if (options.roundRadius > 0) {
              ...
              dotNetRef.invokeMethodAsync('AnimateRoundedRangeBar', options.midPointX, options.midPointY, Math.floor(options.minimumAngle), roundedActualEnd + 0.0001, options.oldStart, roundedOldEnd + 0.0001, options.radius, options.pointerWidth, pointerIndex, axisIndex, options.roundRadius);
            } else {
            ...
            if (options.roundRadius > 0) {
              ...
              dotNetRef.invokeMethodAsync('AnimateRoundedRangeBar', options.midPointX, options.midPointY, roundedActualEnd, Math.floor(options.oldStart) + 0.0001, roundedOldEnd, Math.floor(options.oldStart + options.roundRadius / 2), options.radius, options.pointerWidth, pointerIndex, axisIndex, options.roundRadius);
            } else {
