  ...
  (function (ListBase) {
    ...
    fields, className, options, componentInstance) {
      ...
      if (grpLI && options && options.groupTemplate) {
        // eslint-disable-next-line @typescript-eslint/ban-types
        var compiledString = sf.base.compile(options.groupTemplate); // eslint-disable-next-line
        ...
        // eslint-disable-next-line @typescript-eslint/ban-types
        var compiledString = sf.base.compile(options.template); // eslint-disable-next-line
