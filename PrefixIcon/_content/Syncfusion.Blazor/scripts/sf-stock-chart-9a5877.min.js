...
/******/ 	return __webpack_require__(__webpack_require__.s = "./bundles/sf-stock-chart.js");
/******/ })
/************************************************************************/
/******/ ({
    ...
    chartResize: function chartResize(dotnetrefCollection, e) {
      ...
      this.resize = setTimeout(function () {
        ...
        for (var i = 0; i < count; i++) {
          ...
          tempDotnetref.invokeMethodAsync('StockChartRemoveElements');
        }
