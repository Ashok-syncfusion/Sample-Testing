...
/******/ 	return __webpack_require__(__webpack_require__.s = "./bundles/sf-colorpicker.js");
/******/ })
/************************************************************************/
/******/ ({
...
window.sfBlazor.ColorPicker = function () {
  ...
  var ColorPicker = {
    initialize: function initialize(element, dotnetRef, inline) {
    ...
    getOffset: function getOffset(element, container) {
    ...
    focusIn: function focusIn(element, inline) {
      if (!sf.base.isNullOrUndefined(element)) {
