...
window.sfBlazor.ListView = function () {
  ...
  var SfListView = function () {
    ...
    SfListView.prototype.scrollHandler = function (e) {
      ...
      var scrollTop = this.isWindow ? e.target.documentElement.scrollTop : e.target.scrollTop; // tslint:enable
    ...
    SfListView.prototype.clickHandler = function (e) {
      if (this.curUlElement) {
        ...
        if (classList.contains(BACKICON) || classList.contains(HEADERTEXT)) {
          ...
          var li = sf.base.closest(target.parentNode, '.' + LISTITEM) ? sf.base.closest(target.parentNode, '.' + LISTITEM) : sf.base.closest(target, '.' + LISTITEM);
    ...
    SfListView.prototype.back = function () {
      if (this.dataSourceLevel.length > 1) {
        ...
        if (!this.showCheckBox) {
          var focused_element = this.curUlElement.querySelectorAll('.' + FOCUSED);
    ...
    SfListView.prototype.updateFocusElement = function (e) {
      var focusedElement = this.curUlElement.querySelector('.' + FOCUSED);
      ...
      var liCollection = this.curUlElement.children;
      ...
      for (var i = 0; i < liCollection.length; i++) {
        if (this.focusId.indexOf(liCollection[i].getAttribute('data-uid')) >= 0) {
          ...
          if (this.enableSelectEvent) {
            this.getSelectEventData(liCollection[i], e);
          }
        }
      }
    };
    ...
    SfListView.prototype.enterKeyHandler = function (e) {
      if (this.curUlElement) {
        ...
        if (this.curUlElement.querySelector('.' + HASCHILD) && li) {
          ...
          this.setSelectLI(li, e);
        } else if (!sf.base.isNullOrUndefined(li)) {
          this.spaceKeyHandler(e);
        }
      }
    };
    ...
    SfListView.prototype.getSelectedItems = function () {
      var liCollection = this.curUlElement.querySelectorAll(".e-check");
      this.selectedItems[this.curDSKey] = [];
    ...
    SfListView.prototype.getSelectEventData = function (liElement, event) {
      ...
      var clickEventArgs = {
        ...
        IsChecked: checked,
        Key: liElement.classList.contains(HASCHILD) && !event.target.classList.contains(CHECKBOXICON) ? this.dataSourceLevel[this.dataSourceLevel.length - 2] : this.curDSKey,
        IsInteracted: event || this.isRootFocus ? true : false,
        Level: this.dataSourceLevel.length > 0 ? this.dataSourceLevel.length - 1 : this.dataSourceLevel.length
      };
    ...
    SfListView.prototype.setSelectedItems = function (selectedElementIdInfo) {
      ...
      if (selectedElementIdInfo.length > 0) {
        this.curUlElement = this.element.querySelector('[data-uid="' + selectedElementIdInfo + '"]').closest("ul");
      } else {
        this.curUlElement = this.element.querySelector("ul");
      }
      ...
      if (isChild) {
        ...
        this.selectedItems[this.curDSKey] = [this.curDSKey];
      }
