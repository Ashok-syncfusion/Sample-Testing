  ...
  var SfMaskedTextBox = function () {
    ...
    SfMaskedTextBox.prototype.focusHandler = function (event) {
      ...
      if (this.options.mask !== null) {
        ...
        if (this.isClicked || this.options.floatLabelType !== 'Always' && (modelValue === null || modelValue === '') && this.options.placeHolder !== null && this.options.placeHolder !== '') {
