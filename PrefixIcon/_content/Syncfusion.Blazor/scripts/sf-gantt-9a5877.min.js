...
window.sfBlazor.Gantt = function () {
  ...
  var Gantt = {
    initialize: function initialize(element, options, dotnetRef) {
      ...
      this.dotnetRef = dotnetRef;
      element.blazor_instance.height = element.offsetHeight;
      element.blazor_instance.width = element.offsetWidth;
      ...
      if (!sf.base.isNullOrUndefined(element.blazor_instance.toolbarElement)) {
        element.blazor_instance.toolbarHeight = element.blazor_instance.toolbarElement.offsetHeight;
      }
    },
    ...
    hideTreeGridScrollBar: function hideTreeGridScrollBar(element) {
      ...
      if (content) {
        ...
        var chartcontent = element.querySelector('.e-chart-scroll-container');
        chartcontent.style.height = content.style.height;
